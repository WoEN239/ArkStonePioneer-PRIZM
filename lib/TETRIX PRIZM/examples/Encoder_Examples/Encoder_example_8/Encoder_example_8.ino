...
void loop() {
  ...
  prizm.setMotorDegrees(200,360,200,360);        // Spin DC motors 1 and 2 at a constant 200 degrees per second rate 360 degrees and stop. 
  ...
  prizm.resetEncoders();       // Reset encoder 1 and 2 count to zero

  prizm.setMotorDegrees(200,360,200,360);       // Spin another 360 degrees
  
  delay(4000);                 // wait here for 4 seconds

  prizm.resetEncoders();       // Reset encoder 1 and 2 count to zero and repeat loop
