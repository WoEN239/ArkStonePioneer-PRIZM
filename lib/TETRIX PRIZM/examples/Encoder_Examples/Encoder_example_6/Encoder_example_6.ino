...
void loop() {
  ...
  prizm.setMotorSpeeds(200,-200);        // Spin DC motors 1 and 2 at a constant 200 degrees per second in opposite directions. The +/- sign of speed parameter determines direction
